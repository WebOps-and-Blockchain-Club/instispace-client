...
class _EventsCardState extends State<EventsCard> {
  ...
  Widget build(BuildContext context) {
    ...
    if (events.time.split("-")[1] == "01") {
      month = "JAN";
    }
    if (events.time.split("-")[1] == "02") {
      month = "FEB";
    }
    if (events.time.split("-")[1] == "03") {
      month = "MARCH";
    }
    if (events.time.split("-")[1] == "04") {
      month = "APRIL";
    }
    if (events.time.split("-")[1] == "05") {
      month = "MAY";
    }
    if (events.time.split("-")[1] == "06") {
      month = "JUNE";
    }
    if (events.time.split("-")[1] == "07") {
      month = "JULY";
    }
    if (events.time.split("-")[1] == "08") {
      month = "AUG";
    }
    if (events.time.split("-")[1] == "09") {
      month = "SEPT";
    }
    if (events.time.split("-")[1] == "10") {
      month = "OCT";
    }
    if (events.time.split("-")[1] == "11") {
      month = "NOV";
    }
    if (events.time.split("-")[1] == "12") {
      month = "DEC";
    }
    ...
    return Card(
        ...
        child: Column(
          ...
          children: [
                        ...
                        child: MarqueeWidget(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                              ...
                              //Conditional Font Size
                              fontSize:
                                  (userId == events.createdById) ? 18 : 18,
                              color: Colors.white,
                            ),
                          ),
                        ),
                        ...
                        Mutation(
                            ...
                            builder: (
                              ...
                              return IconButton(
                                ...
                                icon: events.isStarred
                                    ? const Icon(Icons.star)
                                    : const Icon(Icons.star_border),
                                color: events.isStarred
                                    ? Colors.white
                                    : Colors.white,
                                iconSize: 20,
                              );
            ...
            if (events.linkName != null &&
                events.linkToAction != null &&
                events.linkToAction != "")
              Padding(
                padding: const EdgeInsets.fromLTRB(15, 10, 15, 0),
                child: Center(
                  ...
                  IconButton(
                    onPressed: () => {
                      Add2Calendar.addEvent2Cal(
                        buildEvent(
                            title: events.title,
                            startDate: DateTime.parse(events.time),
                            description: events.description,
                            endDate: DateTime.parse(events.time)
