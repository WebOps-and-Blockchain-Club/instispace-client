    ...
    setState(() {
      ...
      if (prefs?.getString("descriptionControllerNetop") != null) {
        descriptionController.text =
            prefs!.getString("descriptionControllerNetop")!;
      }
      ...
      showAdditional =
          (urlNameController.text.isNotEmpty || urlController.text.isNotEmpty);
    });
  }
                                ...
                                children: [
                                  ...
                                  ElevatedButton(
                                    onPressed: () => {
                                      ...
                                      prefs!
                                          .remove("descriptionControllerNetop"),
                                  ...
                                  ElevatedButton(
                                    onPressed: () => {
                                      prefs!.setString("titleControllerNetop",
                                          titleController.text),
                                      prefs!.setString(
                                          "descriptionControllerNetop",
                                          descriptionController.text),
                                      prefs!.setString("urlControllerNetop",
                                          urlController.text),
                                      prefs!.setString("urlNameControllerNetop",
                                          urlNameController.text),
                                      prefs!.setStringList(
                                          "addNetopTags", selectedTags),
                                    },
                                    child: const Padding(
                                      padding:
                                          EdgeInsets.fromLTRB(15, 5, 15, 5),
                                  ...
                                  Mutation(
                                      options: MutationOptions(
                                          ...
                                          onCompleted: (dynamic resultData) {
                                            print(
                                                "netop resultData : $resultData");
                                            if (resultData["createNetop"] ==
                                                true) {
                                              prefs!.remove(
                                                  "titleControllerNetop");
                                              prefs!.remove(
                                                  "descriptionControllerNetop");
                                              prefs!
                                                  .remove("urlControllerNetop");
                                              prefs!.remove(
                                                  "urlNameControllerNetop");
                                              prefs!.remove("addNetopTags");
                                          ...
                                          onError: (dynamic error) {
                                            ScaffoldMessenger.of(context)
                                              ...
                                              const SnackBar(
                                                  content: Text(
                                                      'Post Creation Failed,server error')),
                                            );
                                          }),
                                      builder: (
