          ...
          if (data["announcements"].isEmpty &&
            ...
            return Scaffold(
              body: Center(
                child: Column(
                  children: [
                    PageTitle('Welcome ${userName.split(" ").first}!!',
                        context),
                    Padding(
            ...
            for (var i = 0; i < data["announcements"].length; i++) {
              all.putIfAbsent(
                  Announcement(
                    ...
                    createdByUserId: data["announcements"][i]["user"]
                    ["id"],
                  ),
                      () => "announcement");
            }
            for (var i = 0; i < data["events"].length; i++) {
              ...
              if (data['events'][i]["photo"] != null &&
                  result.data!['getMe']['getHome']['events'][i]
                  ["photo"] !=
                      "") {
              ...
              all.putIfAbsent(
                eventsPost(
                  ...
                  tags: tags,
                  id: data["events"][i]["id"],
                  createdById: result.data!['getMe']['getHome']['events']
                  [i]['createdBy']['id'],
                  ...
                  createdAt:
                  DateTime.parse(data["events"][i]["createdAt"]),
                ),
                    () => "event",
              );
            }
            ...
            i++) {
              ...
              k <
                  result
                      .data!["getMe"]["getHome"]["netops"][i]["tags"]
                      .length;
              k++) {
                // print("Tag_name: ${netopList[i]["tags"][k]["title"]}, category: ${netopList[i]["tags"][k]["category"]}");
                tags.add(
                  Tag(
                    Tag_name: result.data!["getMe"]["getHome"]["netops"]
                    [i]["tags"][k]["title"],
                    category: result.data!["getMe"]["getHome"]["netops"]
                    [i]["tags"][k]["category"],
              ...
              all.putIfAbsent(
                  NetOpPost(
                    ...
                    createdByName: '',
                    comments: comments,
                    likeCount: result.data!["getMe"]["getHome"]["netops"]
                    [i]["likeCount"],
                    endTime: result.data!['getMe']['getHome']['netops'][i]
                    ['endTime'],
                    attachment: result.data!["getMe"]["getHome"]["netops"]
                    [i]["attachments"],
                    imgUrl: result.data!["getMe"]["getHome"]["netops"][i]
                    ["photo"],
                    linkToAction: result.data!["getMe"]["getHome"]
                    ["netops"][i]["linkToAction"],
                    linkName: result.data!["getMe"]["getHome"]["netops"]
                    [i]["linkName"],
              ...
              if (data["netops"].isEmpty) {
                ...
                i++) {
                  ...
                  k++) {
                    ...
                    tags.add(
                      Tag(
                        Tag_name: result.data!["getMe"]["getHome"]
                        ["netops"][i]["tags"][k]["title"],
                        category: result.data!["getMe"]["getHome"]
                        ["netops"][i]["tags"][k]["category"],
                        id: result.data!["getMe"]["getHome"]["netops"][i]
                        ["tags"][k]["id"],
                      ),
                    );
                  ...
                  j++) {
                    // print("message: ${netopList[i]["comments"][j]["content"]}, id: ${netopList[i]["comments"][j]["id"]}");
                    comments.add(Comment(
                      message: result.data!['getMe']['getHome']['netops']
                      [i]["comments"][j]["content"],
                      id: result.data!['getMe']['getHome']['netops'][i]
                      ["comments"][j]["id"],
                      name: "Name",
                      //ToDO comment name
                  ...
                  all.putIfAbsent(
                      NetOpPost(
                        title: result.data!["getMe"]["getHome"]["netops"]
                        [i]["title"],
                        tags: tags,
                        id: result.data!["getMe"]["getHome"]["netops"][i]
                        ["id"],
                        createdByName: '',
                        comments: comments,
                        likeCount: result.data!["getMe"]["getHome"]
                        ["netops"][i]["likeCount"],
                        endTime: result.data!['getMe']['getHome']
                        ['netops'][i]['endTime'],
                        attachment: result.data!["getMe"]["getHome"]
                        ["netops"][i]["attachments"],
                        imgUrl: result.data!["getMe"]["getHome"]["netops"]
                        [i]["photo"],
                        linkToAction: result.data!["getMe"]["getHome"]
                        ["netops"][i]["linkToAction"],
                        linkName: result.data!["getMe"]["getHome"]
                        ["netops"][i]["linkName"],
                        description: result.data!["getMe"]["getHome"]
                        ["netops"][i]["content"],
                        isLiked: data['netops'][i]['isLiked'],
                ...
                i++) {
                  ...
                  k++) {
                    ...
                    tags.add(
                      Tag(
                        Tag_name: result.data!["getMe"]["getHome"]
                        ["events"][i]["tags"][k]["title"],
                        category: result.data!["getMe"]["getHome"]
                        ["events"][i]["tags"][k]["category"],
                  ...
                  List<String> imageUrls = [];
                  if (result.data!['getMe']['getHome']['events'][i]
                  ["photo"] !=
                      null &&
                      result.data!['getMe']['getHome']['events'][i]
                      ["photo"] !=
                          "") {
                    imageUrls = result.data!['getMe']['getHome']['events']
                    [i]["photo"]
                        .split(" AND ");
                  }
                  ...
                  all.putIfAbsent(
                    eventsPost(
                      ...
                      id: result.data!["getMe"]["getHome"]["events"][i]
                      ["id"],
                      createdById: result.data!['getMe']['getHome']
                      ['events'][i]['createdBy']['id'],
                      // createdByName: result.data!['getMe']['getHome']['events'][i]['createdBy']['name'],
                      createdByName: '',
                      likeCount: result.data!['getMe']['getHome']
                      ['events'][i]['likeCount'],
                      imgUrl: imageUrls,
                      linkName: result.data!['getMe']['getHome']['events']
                      [i]['linkName'],
                      description: result.data!['getMe']['getHome']
                      ['events'][i]['content'],
                      linkToAction: result.data!['getMe']['getHome']
                      ['events'][i]['linkToAction'],
                      time: result.data!["getMe"]["getHome"]["events"][i]
                      ["time"],
                      location: result.data!["getMe"]["getHome"]["events"]
                      [i]["location"],
                      isLiked: result.data!["getMe"]["getHome"]["events"]
                      [i]["isLiked"],
                      isStarred: result.data!["getMe"]["getHome"]
                      ["events"][i]["isStared"],
                      createdAt:
                      DateTime.parse(data["events"][i]["createdAt"]),
                    ),
                ...
                Column(
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: Padding(
                        padding:
                        const EdgeInsets.fromLTRB(0.0, 15, 5, 10),
                        child: Row(
                          mainAxisAlignment:
                          MainAxisAlignment.spaceBetween,
                          children: [
                    ...
                    ///Listing of posts
                    RefreshIndicator(
                      strokeWidth: RefreshProgressIndicator.defaultStrokeWidth*0.5,
