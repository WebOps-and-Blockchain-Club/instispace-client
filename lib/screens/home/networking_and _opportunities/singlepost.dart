...
class Single_Post extends StatelessWidget {
  ...
  Single_Post(
      {required this.post, required this.isStarred, required this.refetch});
  @override
      ...
      child: Column(
          ...
          children: [
                    ...
                    children: [
                      Stack(children: [
                        ...
                        Align(
                          ...
                          child: Mutation(
                              options:
                                  MutationOptions(document: gql(toggleStar)),
                              builder: (
                                ...
                                return IconButton(
                                  onPressed: () {
                                    runMutation({"toggleStarNetopId": post.id});
                                    refetch!();
                                  },
                                  icon: isStarred
                                      ? Icon(Icons.star)
            ...
            if (post.linkToAction != null && post.linkToAction != "")
              Center(
                child: ElevatedButton(
                  onPressed: () => {launch(post.linkToAction!)},
